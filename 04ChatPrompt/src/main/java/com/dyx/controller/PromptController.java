...
public class PromptController
{
    ...
    public String chat5(String city)
    {
        ...
        // ToolResponseMessage 的构造方法在 1.1.x 中是 protected（设计上由框架内部创建）。
        // 这里用匿名子类 {} 的方式合法调用父类 protected 构造方法，仅作演示用。
        ...
        String toolResponse = toolResponseMessage.getResponses().get(0).responseData();
